...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.facade {
	...
	public class FabricationFacade extends Facade implements IDisposable {
		...
		public function startup(startupCommand:Class, application:Object):void {
			...
			if (application is IFabrication) applicationName = (application as IFabrication).id;
			else applicationName = calcApplicationName(startupCommand);
		...
		{
			if ($mvcLogger.debugEnabled) $mvcLogger.debug("executeCommandClass [class: {0}]",getQualifiedClassName(clazz));
		...
		public function registerInterceptorByType(noteName:String, noteType:String, clazz:Class, parameters:Object = null):void {
			fabricationController.registerInterceptorByType(noteName, noteType, clazz, parameters);
		}
		...
		public function removeInterceptorByType(noteName:String, noteType:String, clazz:Class = null):void {
			fabricationController.removeInterceptorByType(noteName,noteType,clazz);
		}
	}
}
