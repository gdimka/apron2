...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.interceptor {
	...
	public class AbstractInterceptor extends SimpleFabricationCommand implements IInterceptor {
		...
		protected var _routedNotification:INotification;
		 ...
		 * The notification object to intercept.
		 */
		public function get routedNotification():INotification {
			return _routedNotification;
		}

		/**
		 * @private
		 */
		public function set routedNotification(notification:INotification):void {
			_routedNotification = notification;
		}
