...
package org.puremvc.as3.multicore.utilities.fabrication.interfaces {
	...
	/**
	 * An interface that represents a last-in-first-out(LIFO) stack of
	 * objects.
	 * 
	...
	public interface IStack extends IDisposable {
		...
		/**
		 * Returns the object at the top of this stack without removing
		 * it from the stack.
		 */
		function peek():Object;
		
		/**
		 * Removes the object from the top of this stack after removing
		 * it from the stack.
		 */
		function pop():Object;
		...
		/**
		 * Returns the number of objects on this stack.
		 */
		function length():int;
