...
package org.puremvc.as3.multicore.patterns.observer
{
	 ...
	 */
	public class Notifier extends SimpleClass implements INotifier
	{ 
		...
		{
			if ($mvcLogger.debugEnabled) $mvcLogger.debug("sendNotification [name: {0}, type: {1}]",notificationName,type);
