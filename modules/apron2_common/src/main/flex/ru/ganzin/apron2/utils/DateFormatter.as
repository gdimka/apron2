package ru.ganzin.apron2.utils
{
	 ...
	 * <listing>
	 * <code>
	 *   	DateFormatter.format( "r" );
	 *   	DateFormatter.format( "r", 1211528051 );
	 * </code></listing>
	 ...
	 *   DateFormatter.format( "r" );
	 * 
	 *   var DateFormatter2:DateFormatter = new DateFormatter( 1211528051 );
	 *   DateFormatter2.format( "r" );
	 * </code></listing>
	 * <p>
	 * If you wan't to take over a given UNIX-Timestamp to DateFormatter you only have
	 * to add the timestamp as a parameter. Remember that only the static 
	 * <code>format()</code> method accept this, if you use an instance you 
	 * should add the timestamp to the constructor.
	 * </p>
	...
	public class DateFormatter
	{
		...
		public static var weekdays:Array = new Array( 
				"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", 
				"Friday", "Saturday" );		
		
		//long and short month names
		public static var months:Array = new Array(
				"January", "February", "March", "April", "May", "June", "July",
				"August", "September", "October", "November", "December" );
		
		//timezone abbrevitation
		public static var timezones:Array = new Array( 
		...
		private static var mondayStartingWeek:Array = new Array( 7, 1, 2, 3, 4, 5, 6 );
		 ...
		 * default constructor
		 * 
		 * @param int a unix timestamp, optional
		 */
		public function DateFormatter( unixTimestamp:int = 0 )
		{
			//checks if a timestamp was given, if not use current time
			if( unixTimestamp == 0 )
			{
				_date = new Date();
			}
		 ...
		 * to use if you won't or can't instantiate the DateFormatter Class
		 *
		 * @static
		 * @param String the format pattern
		 ...
		 * @return the new formated date string
		 */
		public static function formata( format:String, 
				unixTimestamp:int = 0 ):String
		{
			var DateFormatter:DateFormatter = new DateFormatter( unixTimestamp );
			return DateFormatter.parseFormatString( format );
		}
